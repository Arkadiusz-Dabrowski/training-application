...
import { TrainingApplicationSharedModule } from 'app/shared';
import { TrainingApplicationCoreModule } from 'app/core';
...
import { TrainingApplicationAccountModule } from './account/account.module';
...
@NgModule({
  imports: [
    ...
    TrainingApplicationSharedModule.forRoot(),
    TrainingApplicationCoreModule,
    TrainingApplicationHomeModule,
    TrainingApplicationAccountModule,
